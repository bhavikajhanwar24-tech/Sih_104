-- F15: consent register, voice passports, notice assets, retention bounds

-- ---------------------------------------------------------------------------
-- tenant_settings — notice / retention / languages
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- notice_assets — short announcement audio (tenant file, not call PCM)
-- ---------------------------------------------------------------------------
...
-- Public acceptance tokens (OTP-less)
...
-- ---------------------------------------------------------------------------
-- voice_passports — encrypted non-invertible embedding only
-- ---------------------------------------------------------------------------
